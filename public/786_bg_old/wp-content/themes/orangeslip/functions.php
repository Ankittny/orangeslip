...
function my_page_bloglist() {
	
	$last_100_posts_query = new WP_Query( array( 'posts_per_page' => 100, 'category_name' => 'blogs', 'order' => 'DESC','orderby' => 'link' ) );
	$content = '';
	...
	if ( has_post_thumbnail() ) {
		...
		$content .='<div class="inner-blogs"><div class="blog_box ">
<div class="container">
		   ...
		   <div class="col-md-12 col-lg-12">
			  <div class="blog_contain">
				 ...
				 <div class="d-flex justify-content-between mt-2">
					<a href="'.$link.'" class="blog_details_link">Read More <img src="'.get_template_directory_uri() .'/assets/img/icon/blog_link_arrow.png" ></a>
					<span class="blog_date"><i class="fa fa-calendar-o"></i> '.$postdate.'</span>
				 </div>
...
add_shortcode('my_page_bloglist', 'my_page_bloglist' );