...
<div class="pxp-dashboard-content-details">
    ...
    <div class="d-flex justify-content-between">
        <h4 class="text-themecolor">Edit Verification Head</h4>
        <a href="{{url('verification_head_list')}}"><i class="fa fa-long-arrow-left"></i> Back</a>
    </div>
    

    <form action="{{url('update_verification_head')}}/{{$user->id}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
