...
<div class="pxp-dashboard-content-details">
    ...
    <div class="d-flex justify-content-between">
        <h4 class="text-themecolor">Edit Verification Staff</h4>
        <a href="{{url('verification_staff_list')}}"><i class="fa fa-long-arrow-left"></i> Back</a>
    </div>
    

    <form action="{{url('update_Verification_staff')}}/{{$user->id}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">           
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" id="email" name="email" class="form-control" placeholder="Enter Email" value="{{$user->email}}" required>
                    @if ($errors->has('email'))
