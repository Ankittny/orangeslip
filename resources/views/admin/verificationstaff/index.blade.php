        ...
        @endif
            ...
            <h5>Search By</h5>
                <div class="">
		            ...
		            <form name="search" method="get" action="{{url('verification_staff_list')}}">
     			    <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                    ...
                                    <a href="{{route('editVerificationStaff',[$head->user_id])}} " class="btn btn-sm btn-rounded btn-warning">Edit</a>  
...
$(document).ready(function(){
		$('.expBtn').click(function() {
            ...
            var file_path = url + '/verification_staff_list?' + formData + '&export=true';  
