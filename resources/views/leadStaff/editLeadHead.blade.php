...
<div class="pxp-dashboard-content-details">
    ...
    <div class="d-flex justify-content-between">
        <h4 class="text-themecolor">Edit Lead Head</h4>
        <a href="{{url('lead_head_list')}}"><i class="fa fa-long-arrow-left"></i> Back</a>
    </div>
    

    <form action="{{url('update_lead_head')}}/{{$user->id}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">           
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" id="email" name="email" class="form-control" placeholder="Enter Email" value="{{old('last_name',$user->email)}}" required>
                    @if ($errors->has('email'))
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="gender" class="form-label">Gender * {{$user->profile->gender}}</label>
