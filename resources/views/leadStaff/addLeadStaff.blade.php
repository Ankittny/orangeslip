...
<div class="pxp-dashboard-content-details">
    <h1>Add Lead Staff</h1>
    

    <form action="{{ route('saveLeadStaff') }}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="head" class="form-label">Lead Head *</label>
                ...
                @if ($errors->has('head'))
                        <label class="text-danger">{{ $errors->first('head') }}</label>
                    @endif
            </div>
            @endif
