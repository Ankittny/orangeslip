        ...
        @endif
            ...
            <h5>Search By</h5>
                <div class="">
		            ...
		            <form name="search" method="get" action="{{url('lead_staff_list')}}">
     			    <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(Auth::user()->account_type=='superadmin')
                                    ...
                                    <button type="submit" class="btn btn-sm btn-rounded btn-primary">Login as Lead Staff</button>
                                    </form> 
                                @endif
                                    <a href="{{url('change_status')}}/{{$head->user_id}}" class="btn btn-sm btn-rounded btn-warning" onclick="return confirm('Are you sure to {{$head->status==1 ? 'Deactive':'Active'}} ?');">{{$head->status==1?"Deactive":"Active"}}</a>  
                                    <a href="{{route('editLeadStaff',[$head->user_id])}} " class="btn btn-sm btn-rounded btn-warning">Edit</a>  
...
$(document).ready(function(){
		$('.expBtn').click(function() {
            ...
            var file_path = url + '/lead_staff_list?' + formData + '&export=true';  
