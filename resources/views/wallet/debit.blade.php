...
<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Debit Balance</h4>
                ...
                <div class="sm_box">
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <p>Debitor Details: Name: <strong>{{$user->first_name}}</strong>, Email: <strong>{{$user->email}}</strong>,  Type: <strong>{{$user->account_type}}</strong></p>
                            <form method="POST" action="{{ url('debit_amount') }}/{{$id}}">
                                @csrf
