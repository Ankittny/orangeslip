...
<head>
    ...
    <style>
        *{margin: 0px; padding: 0px;}
        ...
        .offer_letter_container{max-width: 800px; position: relative; margin: auto; }
        .offer_letter_box{background: #fff; padding: 20px 40px; min-height: 800px;}
        .logo_box{margin-bottom: 20px; padding: 20px 10px; position: relative;}
        .logo_box img{max-width: 230px;}
        .offer_letter_box h1{font-weight: 500; font-size: 27px;}
        .text-right{text-align: right;}
        .mt-4{margin-top: 20px;}
        .mb-4{margin-bottom: 20px;}
        .mb-3{margin-bottom: 15px;}
        .mb-3{margin-bottom: 15px;}
        .l_border{position: absolute; top: 0; left: 0;}
        .r_border{position: absolute; bottom: 0; right: 0;}
    ...
    <div class="offer_letter_container">
        <div class="offer_letter_box">
          ...
          @php
            ...
            <p class="mt-4 text-right">Power By <strong>{{env('APP_NAME')}}</strong></p>
            
        </div>
       <img class="l_border" src="{{asset('/new/images/l-border.png')}}" alt="">
       <img class="r_border" src="{{asset('/new/images/r-border.png')}}" alt="">
    </div>
