...
<head>
    ...
    <style>
        *{margin: 0px; padding: 0px;}
        ...
        .offer_letter_box{background: #fff; padding: 20px 40px; min-height: 600px;}
        .logo_box{color: #fff; background: #181947;  padding: 15px 10px; padding-left: 100px; position: relative;}
       .logo_box .logo{max-width: 200px; filter: brightness(0) invert(1);}
       .logo_box .design1{position: absolute; height: 100%; left: 0; top: 0; bottom: 0;}
       .footer_design .design2{position: absolute; height: 100%; right: 0; top: 0; bottom: 0;}
       .footer_design .design3{position: absolute; height: 100%; left: 0; top: 0; bottom: 0;}
       .footer_design{position: relative; background: #fff; padding: 15px 0px;}
        .offer_letter_box h1{text-align: center; font-weight: 400; font-size: 22px;}
...
<body class="offer_letter_bg">
    <div class="offer_letter_container">
        <div class="logo_box">
            <img class="design1" src="design1.png" alt="" >
            <img class="logo" src="{{ ($business->logo!='')?(url('images/'.$business->logo)):(url('/new/images/logo.png')) }}" alt="" >
        </div>
       
        <div class="offer_letter_box">
            <h1 class="mb-4 mt-4 text-center">Appointment Letter</h1>
           <p class="text-right mt-4">Date- {{date('d-m-Y', strtotime($offer_letter->updated_at))}}</p>

            <!-- <p class="mb-3"><strong>Subject :</strong> What is Lorem Ipsum?</p> -->
            <p>To,</p>
         ...
         <div class="footer_design">
            <p class="text-center">Power By <strong>{{env('APP_NAME')}}</strong></p>
            <img class="design2" src="{{asset('design11.png')}}" alt="" >
            <img class="design3" src="{{asset('design11.png')}}" alt="" >
        </div>
