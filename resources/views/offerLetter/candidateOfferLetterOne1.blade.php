...
<head>
    ...
    <style>
        *{margin: 0px; padding: 0px;}
        ...
        .logo_box{color: #fff; background: url({{asset('/new/images/logo_background.png')}})no-repeat center; background-size: cover; text-align: center; padding: 25px 10px; position: relative;}
       .logo_box img{max-width: 230px; margin-bottom: 10px; filter: brightness(0) invert(1);}
        .logo_box h1{text-align: center; font-weight: 400; font-size: 22px;}
